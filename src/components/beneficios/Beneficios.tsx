        ...
        <footer className="bg-[--cor-secundaria] mt-8 mb-4">
            <ul className="flex flex-col gap-4 md:flex-row p-4 xl:p-6 xl:gap-6 bg-zinc-300 text-black">
                <li className="flex flex-col py-4 w-full gap-2 items-center md:flex-1">
                    ...
                    <h2 className="text-2xl leading-6 text-center font-black uppercase">Frete gratis</h2>
                    <p className="leading-4 text-center fonte-regular">Em compras a partir de R$299,90</p>
                </li>
                <li className="flex flex-col py-4 w-full gap-2 items-center md:flex-1">
                    <FaStopwatch className="text-[3em]"/>
                    <h2 className="text-2xl leading-6 text-center font-black uppercase">Entrega Rápida</h2>
                ...
                <li className="flex flex-col py-4 w-full gap-2 items-center md:flex-1">
                    ...
                    <h2 className="text-2xl leading-6 text-center font-black uppercase">Em até 10 vezes sem juros</h2>
