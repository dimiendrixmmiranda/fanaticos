        ...
        >
            ...
            >
                <div className="flex justify-between">
                    <button className="font-bold text-sm" onClick={() => useFavotites.toggleBtnFavorite()}>Voltar para loja</button>
                    <button className="font-bold text-xl" onClick={() => useFavotites.toggleBtnFavorite()}>
                        <TiDelete />
                    </button>
                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button
                                                        ...
                                                        onClick={() => useFavotites.removeFavorite(item)}
                                                    >
                                                        Remover
                                                    </button>
                                                </div>
