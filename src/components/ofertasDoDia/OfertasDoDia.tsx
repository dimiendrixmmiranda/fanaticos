...
export default async function OfertasDoDia() {
    ...
    return (
        <section className="flex flex-col gap-4 mt-4">
            <h2 className="uppercase font-black text-3xl bg-azul-escuro flex justify-center w-full items-center py-2 text-laranja text-center md:text-4xl md:mx-auto" style={{textShadow: '1px 1px 2px white'}}>Ofertas do Dia!</h2>
