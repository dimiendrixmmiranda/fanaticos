...
export default function Favoritos({ mobile }: CartProps) {
    ...
    return (
        <>
            <div
                className={`items-center justify-center justify-self-center relative cursor-pointer w-20 h-12 ${mobile ? 'flex bg-azul-escuro justify-center p-2 rounded-lg' : 'hidden lg:flex'}`}
