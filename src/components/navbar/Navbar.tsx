...
export default function Navbar() {
    ...
    const renderizarTimesFutebol = (idLiga: number) => {
        ...
        return times.map(time => (
            <li key={time.idLiga} className="p-2 hover:bg-azul">
                <Link href={'/'}>
            ...
            <ul className="flex gap-4 w-full h-fit">
                ...
                <li className={`relative h-fit ${styles.futebol}`}>
                    <div className="flex flex-col relative">
                        <button
                            ...
                            className={`flex items-center gap-1 p-2 rounded-md hover:bg-magenta ${openMenu != null && openMenu === "futebol" ? 'bg-magenta' : ''}`}
                        >
                ...
                <li className={`relative ${styles.nba}`}>
                    <div className="flex flex-col relative">
                        <button
                            ...
                            className={`flex items-center gap-1 p-2 rounded-md hover:bg-magenta ${openMenu != null && openMenu === "nba" ? 'bg-magenta' : ''}`}
                        >
                ...
                <li className={`relative ${styles.nfl}`}>
                    <div className="flex flex-col relative">
                        <button
                            ...
                            className={`flex items-center gap-1 p-2 rounded-md hover:bg-magenta ${openMenu != null && openMenu === "nfl" ? 'bg-magenta' : ''}`}
                        >
                ...
                <li className={`relative ${styles.esports}`}>
                    <button
                        ...
                        className={`flex items-center gap-1 p-2 rounded-md hover:bg-magenta ${openMenu != null && openMenu === "esports" ? 'bg-magenta' : ''}`}                    >
                ...
                <li className={`relative ${styles.f1}`}>
                    <div className="flex flex-col relative">
                        <button
                            ...
                            className={`flex items-center gap-1 p-2 rounded-md hover:bg-magenta ${openMenu != null && openMenu === "f1" ? 'bg-magenta' : ''}`}
                        >
