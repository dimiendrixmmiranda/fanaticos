export default function Newsletter() {
    return (
        <div className="p-4 text-white bg-zinc-400 flex flex-col gap-4 max-w-[1200px] mx-auto mt-6 md:grid md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col gap-1">
                <button className="uppercase font-bold text-xl bg-azul-escuro p-2 text-white">Aceitar e Cadastrar</button>
